...
const SubWrapper1 = styled.div<{ show: boolean }>`
  &&& {
    ...
    border-radius: 16px;
    border: ${({ show, theme }) => (show ? `1px solid #c2c640` : "none")};
    // border: 1px solid;
      ...
      <MainWrapper>
        ...
        <SubWrapper1 show={betTaken}>
          ...
          <StyledMainCircle>
            <TeamADiv>
              <StyledCircle>
                <Team1 src={teamLogos && teamLogos[question.team_a_code]} />
              </StyledCircle>
              <StyledText
                fontSize="14px"
                textAlign="center"
            ...
            <TeamBDiv>
              ...
              <StyledCircle>
                <Team1 src={teamLogos && teamLogos[question.team_b_code]} />
              </StyledCircle>
            </TeamBDiv>
          </StyledMainCircle>
          <StyledText
        ...
        {/* <HeaderDiv>
          ...
          <StyledTimer>
            <StyledText fontWeight="bold" fontSize={`13px`}>
              {timeStamp < getEpoch(question.bid_start_time) ? (
                <span style={{ color: "#FF4C29" }}>
                  Starts in{" "}
        ...
        <Cards>
          <Box1>
            <HeaderDiv>
              ...
              <StyledHead>{question.tournament}</StyledHead>
              <StyledTimer>
                <StyledTextTimer fontWeight="bold" fontSize={`13px`}>
                  {timeStamp < getEpoch(question.bid_start_time) ? (
                    <span style={{ color: "#FF4C29" }}>
                      Starts in{" "}
                      {secondsToDHms(
